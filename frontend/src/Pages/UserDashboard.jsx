...
const UserDashboard = () => {
  ...
  const handlePayBill = async () => {
    alert("Payments are handled by the administrator. Please contact support.");
  };
  ...
  <div className="bill-card">
    ...
    >
      ...
      <div style={{ display: "flex", gap: "0.5rem" }}>
        <button className="btn-view-invoice" onClick={() => onView(bill)}>
          View Invoice
        </button>
    ...
    >
      <div className="invoice-modal">
        ...
        <div className="invoice-footer">
          <button className="btn-view-invoice" onClick={handlePrint}>
            <FaPrint /> Print
          </button>
          {bill.paymentStatus === "Unpaid" && (
            <button
...
//     setLoadingBill(true);
//     try {
//       const res = await billAPI.getAll("?limit=50");
...
//   //   fetchBills();
//   //   fetchProfile();
//   // }, [currentUser, navigate, fetchAppointments, fetchBills, fetchProfile]);
//   useEffect(() => {
//   if (!currentUser) {
//     navigate("/login");
//     return;
...
//   // User dashboard is view-only (admin handles all billing actions).
//   const handlePayBill = async () => {
//     alert("Payments are handled by the administrator. Please contact support.");
//   };
...
//   const unpaidBills  = bills.filter(b => b.paymentStatus === "Unpaid").length;
//   const totalDue     = bills.filter(b => b.paymentStatus === "Unpaid").reduce((s, b) => s + b.totalAmount, 0);
